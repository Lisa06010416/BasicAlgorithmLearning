...
| 69. Sqrt(x)                               | Given a non-negative integer `x`, return *the square root of* `x` *rounded down to the nearest integer*. The returned integer should be **non-negative** as well.<br>Input: x = 8 Output: 2 | 1. Binary search<br><img src="readme.assets/截圖 2023-03-10 上午1.26.10.png" alt="截圖 2023-03-10 上午1.26.10" style="zoom:50%;" /><br>2. 用2的指數去找上限，在一個一個往回找sqrt |
...
| 148. Sort List                          | 排序一個linking list，時間複雜度Ｏ(nlogn)、空間複查度Ｏ(1)   | merge sort, linking list<img src="readme.assets/截圖 2023-03-11 下午4.31.21.png" alt="截圖 2023-03-11 下午4.31.21" style="zoom:150%;" /> |
