...
| hash基本的做法？時間複雜度？         | item -> hashfunction(item) -> hash code/index -> store item in hashtable[index] / key。avg 都是Ｏ(1)，worse O(n)<br><img src="readme.assets/截圖 2023-01-23 下午10.09.17.png" alt="截圖 2023-01-23 下午10.09.17" style="zoom:50%;" /> |
| hash 最常見的問題是什麼？ | 散列冲突”(hash collisions)，有資料hash後取mod後要放在hash table的同一格|
